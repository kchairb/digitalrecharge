  ...
  return (
    <div className="space-y-5">
      <div className="glass-card flex flex-wrap items-center justify-between gap-3 p-4">
        <div>
          <p className="text-sm font-semibold tracking-wide text-white">{copy.adminWorkspace}</p>
          <p className="mt-1 text-xs text-slate-400">
            {copy.adminWorkspaceDesc}
          </p>
        </div>
        <Link
          href="/"
      ...
      <div className="grid gap-6 lg:grid-cols-[260px_1fr]">
        <aside className="glass-card h-fit p-4 lg:sticky lg:top-24">
          <p className="text-sm font-semibold tracking-wide text-white">{copy.adminPanel}</p>
          <AdminNav lang={lang} />
        </aside>
